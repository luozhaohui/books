...
我写了一个Python爬虫，能自动将改豆列整理为Markdown格式，便于在网页上查看。整理之后的页面请访问这里：
。

该爬虫工具源码在这里：


有需要导出豆列的朋友，可以修改源码最后一行中的豆列url为你想要导出的豆列地址即可，当然前提是你得学会配Python环境。


## 图书列表
### 总计 101 本，更新时间：2016-07-21 17:12:59 
